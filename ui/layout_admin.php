...
<html class="no-js" lang="en">
  <head>
    ...
    <script type="text/javascript"> function openwindow(){window.open("administration/image_manager", "Promnet","location=1,status=1,scrollbars=1,width=960,height=700");}</script>
  </head>
  <body>
