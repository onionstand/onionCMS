...
(function(){
	...
	if (! require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts : {
				//url : '/v_admin/elfinder/php/connector.minimal.php' // connector URL (REQUIRED)
				getFileCallback : function(file, fm) {
					document.getElementById("image_main").value = file.url;
					tooltip.hideAllTooltips();
				},
				url : '/v_admin/elfinder/php/connector.minimal.php',
				soundPath: '/v_admin/elfinder/sounds/',
